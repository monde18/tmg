...
(22749, '06101', 23430, 22252, '2025-06-24 09:41:00', 'san jose', 0, 'Paid', '2025-06-24 09:54:05', 4000.00),
(22750, '06102', 23430, 22253, '2025-06-24 10:05:00', 'san jose', 0, 'Paid', '2025-06-24 10:06:00', 500.00),
(22751, '06103', 23431, 22254, '2025-06-24 10:35:00', 'JJGH', 0, 'Unpaid', NULL, 0.00);
...
(23430, 'KHGFDSA', 'richmond', NULL, NULL, NULL, 'Asassi', 'Baggao', 'Cagayan', 'hjgfh', 'Non-Professional'),
(23431, 'AMBO', 'LIGAN', NULL, NULL, '5', 'Annayatan', 'Baggao', 'Cagayan', '000549646', 'Non-Professional');
...
(22252, '6574hj', 'Tricycle', 'mio'),
(22253, ';LKJH', 'Motorcycle', 'mio'),
(22254, '4564564', 'Motorcycle', 'IHKJ');
...
(23883, 22749, 'COLORUM OPERATION', 1, 23430, 2500.00),
(23884, 22749, 'NO TRASHBIN', 1, 23430, 1000.00),
(23885, 22749, 'OVER CHARGING / UNDER CHARGING', 1, 23430, 500.00),
(23886, 22750, 'NO HELMET (Backrider)', 1, 23430, 150.00),
(23887, 22750, 'NO HELMET (Driver)', 1, 23430, 150.00),
(23888, 22750, 'DRIVING IN SHORT / SANDO', 1, 23430, 200.00),
(23889, 22751, 'NO / EXPIRED VEHICLE REGISTRATION', 1, 23431, 2500.00);
...
ALTER TABLE `citations`
  ...
  ADD KEY `idx_citations_payment` (`payment_status`,`is_archived`);
...
--
ALTER TABLE `citations`
  MODIFY `citation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22752;

--
-- AUTO_INCREMENT for table `drivers`
--
ALTER TABLE `drivers`
  MODIFY `driver_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23432;

--
-- AUTO_INCREMENT for table `remarks`
--
ALTER TABLE `remarks`
  MODIFY `remark_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5647;

--
-- AUTO_INCREMENT for table `vehicles`
--
ALTER TABLE `vehicles`
  MODIFY `vehicle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22255;

--
-- AUTO_INCREMENT for table `violations`
--
ALTER TABLE `violations`
  MODIFY `violation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23890;
