...
(372797, '06104', 38660, 36295, '2025-07-03 16:21:00', 'SAN JOSE', 0, 'Partially Paid', '2025-07-03 16:23:04', 500.00, 'PAY-20250704-0225-80'),
(372798, '06105', 38661, 36296, '2025-07-03 16:32:00', 'SAN JOSE', 0, 'Partially Paid', '2025-07-03 16:32:56', 1000.00, 'PAY-20250704-0225-97');
...
(38661, 'Rrrrr', 'Rogelio', 'G', NULL, '1', 'Canagatan', 'Baggao', 'Cagayan', NULL, NULL);
...
(40, 372797, 'NO HELMET (BACKRIDER)', 1, 38660, 'Unpaid'),
(41, 372797, 'NO HELMET (DRIVER)', 1, 38660, 'Paid'),
(42, 372798, 'NO HELMET (BACKRIDER)', 1, 38661, 'Unpaid'),
(43, 372798, 'NO HELMET (DRIVER)', 1, 38661, 'Paid');
...
--
ALTER TABLE `citations`
  MODIFY `citation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=372799;

--
-- AUTO_INCREMENT for table `drivers`
--
ALTER TABLE `drivers`
  MODIFY `driver_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38662;
...
--
ALTER TABLE `vehicles`
  MODIFY `vehicle_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36297;
